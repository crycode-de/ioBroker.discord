...
Blockly.Words['footer_text'] = { "en": "Footer text", "de": "Fusszeile", "ru": "Текст нижнего колонтитула", "pt": "Texto de rodapé", "nl": "Voettekst", "fr": "Texte de pied de page", "it": "Testo a piè di pagina", "es": "Texto de pie de página", "pl": "Tekst stopki", "zh-cn": "页脚文本" };
Blockly.Words['discord_file_attachment'] = { "en": "File attachment", "de": "Dateianhang", "ru": "Файл вложения", "pt": "Anexo de arquivo", "nl": "Bijlage", "fr": "Pièce jointe", "it": "File allegato", "es": "Archivo adjunto", "pl": "Załącznik", "zh-cn": "文件附件" };
...
const DiscordHelpers = {
  ...
  setupSendToMessageBlock: (block) => {
    ...
    block.appendValueInput('varError')
      .appendField('discord_save_error_in')
      .setCheck('Variable');
...
Blockly.Blocks['discord_create_content'] = {
  init: function () {
    ...
    this.appendDummyInput('dummy').appendField(Blockly.Translate('discord_message_content'));
...
Blockly.Blocks['discord_create_embed'] = {
  init: function () {
    ...
    this.appendDummyInput('dummy').appendField(Blockly.Translate('discord_message_embed'));
...
Blockly.Blocks['discord_create_file'] = {
  init: function () {
    ...
    this.appendDummyInput('dummy').appendField(Blockly.Translate('discord_file_attachmend'));
