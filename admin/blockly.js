...
Blockly.Words['discord_edit_message_tooltip'] = { 'en': 'Edit a former message in Discord', 'de': 'Eine frühere Nachricht in Discord bearbeiten', 'ru': 'Редактировать предыдущее сообщение в Discord', 'pt': 'Editar uma mensagem anterior no Discord', 'nl': 'Bewerk een eerder bericht in Discord', 'fr': 'Modifier un ancien message dans Discord', 'it': 'Modifica un messaggio precedente in Discord', 'es': 'Editar un mensaje anterior en Discord', 'pl': 'Edytuj poprzednią wiadomość w Discord', 'zh-cn': '在 Discord 中编辑以前的消息' };
Blockly.Words['discord_delete_message'] = { 'en': 'Delete Discord message', 'de': 'Discord-Nachricht löschen', 'ru': 'Удалить Discord-сообщение', 'pt': 'Excluir mensagem do Discord', 'nl': 'Discord-bericht verwijderen', 'fr': 'Supprimer le message Discord', 'it': 'Elimina messaggio Discord', 'es': 'Eliminar mensaje de discordia', 'pl': 'Usuń wiadomość z Discorda', 'zh-cn': '删除 Discord 消息' };
Blockly.Words['discord_delete_message_tooltip'] = { 'en': 'Delete a former message in Discord', 'de': 'Lösche eine frühere Nachricht in Discord', 'ru': 'Удалить прежнее сообщение в Discord', 'pt': 'Excluir uma mensagem anterior no Discord', 'nl': 'Een eerder bericht verwijderen in Discord', 'fr': 'Supprimer un ancien message dans Discord', 'it': 'Elimina un messaggio precedente in Discord', 'es': 'Eliminar un mensaje anterior en Discord', 'pl': 'Usuń poprzednią wiadomość w Discord', 'zh-cn': '在 Discord 中删除以前的消息' };
...
Blockly.Words['discord_emoji'] = { 'en': 'Emoji', 'de': 'Emoji', 'ru': 'эмодзи', 'pt': 'Emoji', 'nl': 'Emoji', 'fr': 'Émoji', 'it': 'Emoji', 'es': 'emoticonos', 'pl': 'Emoji', 'zh-cn': '表情符号' };
